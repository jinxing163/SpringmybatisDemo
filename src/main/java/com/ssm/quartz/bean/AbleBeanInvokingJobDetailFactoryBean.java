...
public class AbleBeanInvokingJobDetailFactoryBean implements FactoryBean, BeanNameAware, InitializingBean, ApplicationContextAware
{
	/**
	...
	public void afterPropertiesSet() throws Exception
	{
		try
		{
			...
			jobDetail.setName(this.jobDetailName==null?this.beanName:this.jobDetailName);
